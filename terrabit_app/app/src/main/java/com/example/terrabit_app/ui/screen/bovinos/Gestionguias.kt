...
fun GestionGuias(
    ...
    if (mostrarDialogoError) {
        AlertDialog(
            ...
            title = {
                Text(stringResource(R.string.error_create_guide), fontWeight = FontWeight.Bold,
                    fontSize = 20.sp, color = MaterialTheme.colorScheme.onSurface)
            },
            text = {
                Text(
    ...
    if (mostrarDatePickerSortida && !modoLectura) {
        ...
        DatePickerDialog(
            ...
            confirmButton = {
                TextButton(onClick = {
                    datePickerState.selectedDateMillis?.let { viewModel.seleccionarFechaSortida(it) }
            ...
            Column(
                    ...
                    Column(
                        ...
                        DropdownField(
                            ...
                            onSeleccionar = { codigo, nombre ->
                                if (!modoLectura) viewModel.seleccionarTemporal(nombre, codigo)
                            },
                            accentColor = MainOrange
                        )
                        ...
                        Row(modifier = Modifier.fillMaxWidth(),
                            ...
                            DateTimeField(
                                ...
                                value = dataSortida, placeholder = datePlaceholder,
                                icon = { Icon(Icons.Default.DateRange, null, tint = MainOrange) },
                                onClick = { if (!modoLectura) viewModel.mostrarDatePickerSortida() }
                            )
                            DateTimeField(
                                modifier = Modifier.weight(1f),
                                label = stringResource(R.string.form_hour_arrival),
                                value = horaSortida, placeholder = hourPlaceholder,
                                icon = { Icon(Icons.Default.Schedule, null, tint = MainOrange) },
                                onClick = { if (!modoLectura) viewModel.mostrarTimePickerSortida() }
                            )
                        }
                        ...
                        Row(modifier = Modifier.fillMaxWidth(),
                            ...
                            DateTimeField(
                                ...
                                value = dataArribada, placeholder = datePlaceholder,
                                icon = { Icon(Icons.Default.DateRange, null, tint = MainOrange) },
                                onClick = { if (!modoLectura) viewModel.mostrarDatePickerArribada() }
                            )
                            DateTimeField(
                                modifier = Modifier.weight(1f),
                                label = stringResource(R.string.form_hour_arrival),
                                value = horaArribada, placeholder = hourPlaceholder,
                                icon = { Icon(Icons.Default.Schedule, null, tint = MainOrange) },
                                onClick = { if (!modoLectura) viewModel.mostrarTimePickerArribada() }
                            )
                        }
                        ...
                        DropdownField(
                            ...
                            onSeleccionar = { codigo, nombre ->
                                if (!modoLectura) viewModel.seleccionarMobilitat(nombre, codigo)
                            },
                            accentColor = MainOrange
                        )
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(stringResource(R.string.form_movs_title_optionals),
                            fontSize = 18.sp, fontWeight = FontWeight.Bold,
                            color = MaterialTheme.colorScheme.onSurface)
                            ...
                            identificadors.forEachIndexed { index, identificador ->
                                Card(
                                    ...
                                    Column(
                                                ...
                                                IconButton(
                                                    ...
                                                    Icon(Icons.Default.Delete,
                                                        contentDescription = stringResource(
                                                            R.string.content_desc_remove_id),
                                                        tint = ErrorRed,
                                        ...
                                        if (!modoLectura) {
                                            useDebounce(identificador, delayMillis = 300L) {
                                        ...
                                        CampoIdentificadorAutoComplete(
                                            ...
                                            onValueChange = {
                                                if (!modoLectura)
                                                    viewModel.actualizarIdentificador(index, it)
                                            },
                                            suggestions = if (modoLectura || activeIndex != index)
                                                emptyList() else suggestionsBovinos,
                                            onAnimalSelected = {
                                                if (!modoLectura)
                                                    viewModel.onBovinoSelected(index, it)
                                            },
                ...
                if (!modoLectura) {
                    Button(
                        ...
                        Text(stringResource(R.string.btn_create_guide),
    ...
    Column(Modifier.fillMaxWidth()) {
        ...
        if (isChecked) {
            CampoTexto(
                ...
                onValueChange = { if (!modoLectura) viewModel.actualizarPais(it) },
            ...
            CampoTexto(
                ...
                onValueChange = { if (!modoLectura) viewModel.actualizarCodiExplotacio(it) },
                defectColor = false, enabled = !modoLectura
            )
        }
    }
